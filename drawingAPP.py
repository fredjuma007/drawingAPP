...
class Draw():
    def __init__(self, root):
        ...
        # Defining title and size of the Tnkinter window graphic userface
        self.root = root
        self.root.title("FRED JUMA'S PAINT APP")
        #         self.root.geometry("810x530")
        self.root.configure(background="white")
        #         self.root.resizable(0,0)

        # pointer and eraser var
        self.pointer = "black"
        self.erase = "white"
        ...
        # Insert a Text
        text.insert("1.0", "FRED'S PAINTER")
